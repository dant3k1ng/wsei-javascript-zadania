...
window.addEventListener('load', function () {
    ...
    let fruits = ["Jab³ko", "Ananas", "Banan", "Pomarañcza", "Œliwka", "Hurma", "Mango"]
...
window.addEventListener('load', function () {
    ...
    btn.innerHTML = "Usuñ ten przycisk";
...
window.addEventListener('load', function () {
    class Container {
        firstList = ["Ananas", "Mleko", "Chleb", "Makaron", "Myd³o", "Pomidory"];
        secondList = [];
...
window.addEventListener('load', function () {
    ...
    function someString(str) {
        ...
        if (str.includes("Ala")) {
            ...
            div.innerHTML = "S³owo Ala nie wystêpuje w tekœcie.";
            root.appendChild(div);
        }
    }

    let someText = "To jest tekst bez s³owa Ala.";
    someString(someText);
});
...
window.addEventListener('load', function () {
    ...
    let myStrings = ["To jest tablica", "która", "przechowuje", "jakieœ s³owa", "bez liczb takich jak", "np 1 czy 2", "koniec."];
...
window.addEventListener('load', function () {
    ...
    function newValues(name, surname, age) {
        ...
        if (name.length > 5 || surname.length > 5 || age.length > 5) {
            ...
            button.innerHTML = "Wróæ do stanu pocz¹tkowego";
